...
<Tabs>
  ...
  <Tab title="Other clients">
    Any client that supports remote MCP servers over streamable HTTP can connect to Kepler. Add `https://mcp.kepler.ai/api/mcp/v1` as a remote MCP server; Kepler signs you in with standard OAuth 2.1. No API keys to manage — authentication is handled through your Kepler login.
  </Tab>
</Tabs>
