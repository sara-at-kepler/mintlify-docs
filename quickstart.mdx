...
<Steps>
  ...
  <Step title="Let Kepler work">
    Kepler finds the relevant filings and transcripts, extracts the figures, and writes an answer. A run typically takes a few minutes — you'll see live progress as it reads sources and builds results.

    <Frame caption="Kepler works through the request, listing the sources it reads as it goes.">
      <img src="/images/research-progress.jpg" alt="Kepler showing live progress and the SEC filings it is reading" />
    </Frame>
  </Step>
  <Step title="Read the answer and check the sources">
    ...
    <Frame caption="Click any figure to trace it to the exact line in the filing — here a workbook cell maps to Apple's 10-K.">
      <img src="/images/citation-source.jpg" alt="A workbook cell selected, with the matching value highlighted in Apple's 10-K alongside it" />
    </Frame>
  </Step>
</Steps>
